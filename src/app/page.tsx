...
export const metadata: Metadata = {
  ...
  description:
    "Instantly analyze any Terms of Service or Privacy Policy with our free AI-powered tool. Get clear summaries and understand the fine print before you agree.",
};
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="flex flex-col items-center">
              ...
              <p className="text-light-gray">
                Copy the URL of the policy you want to check.
              </p>
            </div>
            <div className="flex flex-col items-center">
              <div className="bg-blue-500/20 text-blue-300 rounded-full h-16 w-16 flex items-center justify-center text-2xl font-bold mb-4">
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="text-light-gray">
                Receive a clear summary and scannable key points.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="text-center mb-24 sm:mb-32">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <FeatureCard title="Powered by Advanced AI">
              We use a fine-tuned AI model to provide analysis that is more
